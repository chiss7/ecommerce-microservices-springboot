...
import com.chis.ecommerce.kafka.order.Product;
...
/**
 * Service responsible for sending email notifications to customers.
 * This service utilizes Spring's JavaMailSender and Thymeleaf template engine to send transactional emails.
...
public class EmailService {
    ...
    /**
     * Sends an email to confirm a successful payment.
    ...
    /**
     * Sends an email to confirm a customer's order.
     * @param destinationEmail
     * @param customerName
     * @param amount
     * @param orderReference
