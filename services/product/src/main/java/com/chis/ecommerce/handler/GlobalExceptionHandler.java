...
public class GlobalExceptionHandler {
    ...
    /**
     * This method will handle ProductPurchaseException exceptions thrown anywhere in the application.
     * @param exp
     * @return ResponseEntity<String> with http status 400 and error message in body.
     */
    @ExceptionHandler(ProductPurchaseException.class) // This method should be called when ProductPurchaseException occurs.
